...
public class EmlInJarLSResourceResolverTest {
	...
	/**
	 * Can we resolve a URL based resource?
	 */
	@Test
	public void testResolveResource01() {
		EmlInJarLSResourceResolver objectUnderTest = new EmlInJarLSResourceResolver("some/base/");
	...
	/**
	 * Can we resolve a local file based resource?
	 */
	@Test
	public void testResolveResource02() {
		...
		String systemId = "test-eml-schema.xsd";
		String baseURI = null;
		LSInput result = objectUnderTest.resolveResource(type, namespaceURI, null, systemId, baseURI);
		result.getStringData();
	}
