...
public class Person {
    ...
    public Person withGivenName(String... values) {
        if (values!= null) {
    ...
    public Person withGivenName(Collection<String> values) {
        if (values!= null) {
    ...
    public Person withEmail(String... values) {
        if (values!= null) {
            for (String value: values) {
                getEmail().add(value);
            }
    ...
    public Person withEmail(Collection<String> values) {
        if (values!= null) {
    ...
    public Person withIsMemberOf(Subject... values) {
        if (values!= null) {
            for (Subject value: values) {
                getIsMemberOf().add(value);
            }
        }
        return this;
    }

    public Person withIsMemberOf(Collection<Subject> values) {
        if (values!= null) {
            getIsMemberOf().addAll(values);
        }
        return this;
    }

    public Person withEquivalentIdentity(Subject... values) {
        if (values!= null) {
            for (Subject value: values) {
                getEquivalentIdentity().add(value);
            }
        }
        return this;
    }

    public Person withEquivalentIdentity(Collection<Subject> values) {
        if (values!= null) {
            getEquivalentIdentity().addAll(values);
        }
        return this;
    }
