...
public class Article {
    ...
    public Article withJournal(String value) {
        setJournal(value);
        return this;
    }

    public Article withVolume(String value) {
        setVolume(value);
        return this;
    }

    public Article withIssue(String value) {
        setIssue(value);
        return this;
    }

    public Article withPageRange(String value) {
        setPageRange(value);
        return this;
    }

    public Article withPublisher(ResponsibleParty value) {
        setPublisher(value);
        return this;
    }

    public Article withPublicationPlace(String value) {
        setPublicationPlace(value);
        return this;
    }

    public Article withISSN(String value) {
        setISSN(value);
        return this;
    }
