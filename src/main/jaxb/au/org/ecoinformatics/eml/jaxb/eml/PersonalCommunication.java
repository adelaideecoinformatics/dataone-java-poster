...
public class PersonalCommunication {
    ...
    public PersonalCommunication withPublisher(ResponsibleParty value) {
        setPublisher(value);
        return this;
    }

    public PersonalCommunication withPublicationPlace(String value) {
        setPublicationPlace(value);
        return this;
    }

    public PersonalCommunication withCommunicationType(String value) {
        setCommunicationType(value);
        return this;
    }

    public PersonalCommunication withRecipient(ResponsibleParty... values) {
        if (values!= null) {
    ...
    public PersonalCommunication withRecipient(Collection<ResponsibleParty> values) {
        if (values!= null) {
