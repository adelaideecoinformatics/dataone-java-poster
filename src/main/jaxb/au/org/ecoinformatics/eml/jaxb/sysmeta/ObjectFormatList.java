    ...
    extends Slice
{
    ...
    public ObjectFormatList withObjectFormat(ObjectFormat... values) {
        if (values!= null) {
            for (ObjectFormat value: values) {
                getObjectFormat().add(value);
            }
        }
        return this;
    }

    public ObjectFormatList withObjectFormat(Collection<ObjectFormat> values) {
        if (values!= null) {
            getObjectFormat().addAll(values);
        }
        return this;
    }
