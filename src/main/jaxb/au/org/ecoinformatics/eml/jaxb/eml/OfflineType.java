...
@XmlType(name = "OfflineType", namespace = "eml://ecoinformatics.org/resource-2.1.1", propOrder = {
    "mediumName",
    "mediumDensity",
    "mediumDensityUnits",
    "mediumVolume",
...
public class OfflineType {
    ...
    public OfflineType withMediumName(String value) {
        setMediumName(value);
        return this;
    }

    public OfflineType withMediumDensity(String value) {
        setMediumDensity(value);
        return this;
    }

    public OfflineType withMediumDensityUnits(String value) {
        setMediumDensityUnits(value);
        return this;
    }

    public OfflineType withMediumVolume(String value) {
        setMediumVolume(value);
        return this;
    }

    public OfflineType withMediumFormat(String... values) {
        if (values!= null) {
    ...
    public OfflineType withMediumFormat(Collection<String> values) {
        if (values!= null) {
    ...
    public OfflineType withMediumNote(String value) {
        setMediumNote(value);
        return this;
    }
