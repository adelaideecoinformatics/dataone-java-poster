...
public class ObjectLocationList {
    ...
    public ObjectLocationList withObjectLocation(ObjectLocation... values) {
        if (values!= null) {
            for (ObjectLocation value: values) {
                getObjectLocation().add(value);
            }
        }
        return this;
    }

    public ObjectLocationList withObjectLocation(Collection<ObjectLocation> values) {
        if (values!= null) {
            getObjectLocation().addAll(values);
        }
        return this;
    }
