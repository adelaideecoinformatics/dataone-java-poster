...
public class Group {
    ...
    public Group withHasMember(Subject... values) {
        if (values!= null) {
            for (Subject value: values) {
                getHasMember().add(value);
            }
        }
        return this;
    }

    public Group withHasMember(Collection<Subject> values) {
        if (values!= null) {
            getHasMember().addAll(values);
        }
        return this;
    }

    public Group withRightsHolder(Subject... values) {
        if (values!= null) {
            for (Subject value: values) {
                getRightsHolder().add(value);
            }
        }
        return this;
    }

    public Group withRightsHolder(Collection<Subject> values) {
        if (values!= null) {
            getRightsHolder().addAll(values);
        }
        return this;
    }
