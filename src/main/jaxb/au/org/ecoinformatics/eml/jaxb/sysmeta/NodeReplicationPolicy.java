...
public class NodeReplicationPolicy {
    ...
    public NodeReplicationPolicy withAllowedNode(NodeReference... values) {
        if (values!= null) {
            for (NodeReference value: values) {
                getAllowedNode().add(value);
            }
        }
        return this;
    }

    public NodeReplicationPolicy withAllowedNode(Collection<NodeReference> values) {
        if (values!= null) {
            getAllowedNode().addAll(values);
        }
        return this;
    }

    public NodeReplicationPolicy withAllowedObjectFormat(String... values) {
        if (values!= null) {
            for (String value: values) {
                getAllowedObjectFormat().add(value);
            }
        }
        return this;
    }

    public NodeReplicationPolicy withAllowedObjectFormat(Collection<String> values) {
        if (values!= null) {
            getAllowedObjectFormat().addAll(values);
        }
        return this;
    }
