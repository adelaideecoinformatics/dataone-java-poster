...
public class SingleDateTimeType {
    ...
    public SingleDateTimeType withCalendarDate(String value) {
        setCalendarDate(value);
        return this;
    }

    public SingleDateTimeType withTime(XMLGregorianCalendar value) {
        setTime(value);
        return this;
    }

    public SingleDateTimeType withAlternativeTimeScale(SingleDateTimeType.AlternativeTimeScale value) {
        setAlternativeTimeScale(value);
        return this;
    }
    ...
    public static class AlternativeTimeScale {
        ...
        public SingleDateTimeType.AlternativeTimeScale withTimeScaleName(String value) {
            setTimeScaleName(value);
            return this;
        }

        public SingleDateTimeType.AlternativeTimeScale withTimeScaleAgeEstimate(String value) {
            setTimeScaleAgeEstimate(value);
            return this;
        }

        public SingleDateTimeType.AlternativeTimeScale withTimeScaleAgeUncertainty(String value) {
            setTimeScaleAgeUncertainty(value);
            return this;
        }

        public SingleDateTimeType.AlternativeTimeScale withTimeScaleAgeExplanation(String value) {
            setTimeScaleAgeExplanation(value);
            return this;
        }

        public SingleDateTimeType.AlternativeTimeScale withTimeScaleCitation(CitationType... values) {
            if (values!= null) {
                for (CitationType value: values) {
                    getTimeScaleCitation().add(value);
                }
            }
            return this;
        }

        public SingleDateTimeType.AlternativeTimeScale withTimeScaleCitation(Collection<CitationType> values) {
            if (values!= null) {
                getTimeScaleCitation().addAll(values);
            }
            return this;
        }
