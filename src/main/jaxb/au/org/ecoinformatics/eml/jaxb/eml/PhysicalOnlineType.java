...
@XmlType(name = "PhysicalOnlineType", namespace = "eml://ecoinformatics.org/physical-2.1.1", propOrder = {
    "onlineDescription",
    "url",
    "connection"
})
public class PhysicalOnlineType {
    ...
    public PhysicalOnlineType withOnlineDescription(String value) {
        setOnlineDescription(value);
        return this;
    }

    public PhysicalOnlineType withUrl(UrlType value) {
        setUrl(value);
        return this;
    }

    public PhysicalOnlineType withConnection(ConnectionType value) {
        setConnection(value);
        return this;
    }
