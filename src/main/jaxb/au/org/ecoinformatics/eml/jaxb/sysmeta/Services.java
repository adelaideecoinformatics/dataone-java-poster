 ...
 *       &lt;sequence>
 *         &lt;element name="service" type="{http://ns.dataone.org/service/types/v1}Service" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class Services {
    ...
    public Services withServices(Service... values) {
        if (values!= null) {
    ...
    public Services withServices(Collection<Service> values) {
        if (values!= null) {
