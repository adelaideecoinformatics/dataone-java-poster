...
@XmlType(name = "SubSuperScriptType", namespace = "eml://ecoinformatics.org/text-2.1.1", propOrder = {
    "content"
})
public class SubSuperScriptType {
    ...
    public SubSuperScriptType withContent(Serializable... values) {
        if (values!= null) {
    ...
    public SubSuperScriptType withContent(Collection<Serializable> values) {
        if (values!= null) {
    ...
    public SubSuperScriptType withLang(String value) {
        setLang(value);
        return this;
    }
