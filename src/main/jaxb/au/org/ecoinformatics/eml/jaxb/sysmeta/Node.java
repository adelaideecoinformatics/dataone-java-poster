...
public class Node {
    ...
    public Node withSubject(Subject... values) {
        if (values!= null) {
    ...
    public Node withSubject(Collection<Subject> values) {
        if (values!= null) {
    ...
    public Node withContactSubject(Subject... values) {
        if (values!= null) {
            for (Subject value: values) {
                getContactSubject().add(value);
            }
        }
        return this;
    }

    public Node withContactSubject(Collection<Subject> values) {
        if (values!= null) {
            getContactSubject().addAll(values);
        }
        return this;
    }
