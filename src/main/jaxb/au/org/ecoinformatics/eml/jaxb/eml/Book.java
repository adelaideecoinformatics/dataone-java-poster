...
public class Book {
    ...
    public Book withPublisher(ResponsibleParty value) {
        setPublisher(value);
        return this;
    }

    public Book withPublicationPlace(String value) {
        setPublicationPlace(value);
        return this;
    }

    public Book withEdition(String value) {
        setEdition(value);
        return this;
    }

    public Book withVolume(String value) {
        setVolume(value);
        return this;
    }

    public Book withNumberOfVolumes(String value) {
        setNumberOfVolumes(value);
        return this;
    }

    public Book withTotalPages(String value) {
        setTotalPages(value);
        return this;
    }

    public Book withTotalFigures(String value) {
        setTotalFigures(value);
        return this;
    }

    public Book withTotalTables(String value) {
        setTotalTables(value);
        return this;
    }

    public Book withISBN(String value) {
        setISBN(value);
        return this;
    }
