...
@XmlType(name = "DistributionType", namespace = "eml://ecoinformatics.org/resource-2.1.1", propOrder = {
    "online",
    "offline",
    "inline",
    "references"
...
public class DistributionType {
    ...
    public DistributionType withOnline(OnlineType value) {
        setOnline(value);
        return this;
    }

    public DistributionType withOffline(OfflineType value) {
        setOffline(value);
        return this;
    }

    public DistributionType withInline(InlineType value) {
        setInline(value);
        return this;
    }

    public DistributionType withReferences(au.org.ecoinformatics.eml.jaxb.eml.ViewType.References value) {
        setReferences(value);
        return this;
    }

    public DistributionType withId(String... values) {
        if (values!= null) {
    ...
    public DistributionType withId(Collection<String> values) {
        if (values!= null) {
            getId().addAll(values);
        }
        return this;
    ...
    public DistributionType withSystem(String... values) {
        if (values!= null) {
            for (String value: values) {
                getSystem().add(value);
            }
    ...
    public DistributionType withSystem(Collection<String> values) {
        if (values!= null) {
    ...
    public DistributionType withScope(ScopeType value) {
        setScope(value);
        return this;
    }
